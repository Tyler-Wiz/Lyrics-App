...
const ArtistUploadForm: FC = () => {
  ...
  return (
    <div className="my-24">
      <div>
        <p className="text-2xl my-8">Upload New Artist</p>
      </div>
      <form onSubmit={handleSubmit(onSubmit)} className="flex gap-6 ">
        ...
        <div className="w-1/3">
          <input
            ...
            className="mb-6 mt-1"
          />
          <div className="w-auto h-[330px] bg-gray-200 rounded-lg flex item items-center justify-center overflow-hidden bg-white">
            {!image ? (
              <p>Image preview</p>
            ) : (
